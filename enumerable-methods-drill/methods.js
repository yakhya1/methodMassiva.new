const users = [
  ...
  // console.log(getUserById(users, 3)); // должен вывести в консоль объект юзера с id === 2
  ...
  return array.filter((i) => delete i.address)
  }
  ...
  function getUsersGeo(array, id) {
    ...
    return array.find((i) => i.id === id ? console.log(i.address.geo) : null)
    }
  ...
  return array.find((i)=> i.id === id ? console.log(i.company)  : null )
  }
  ...
  function changePhone(array, id, phone) {
    return array.map((i)=> i.id === id ? {...i, phone: phone} : i)
        
      }
  console.log(changePhone(users, 1, "093"))
